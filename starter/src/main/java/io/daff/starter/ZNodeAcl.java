 ...
 * @since 2020/2/6
 */
public class ZNodeAcl implements Watcher {
    ...
    public ZNodeAcl(String connectString) {
        try {
            zookeeper = new ZooKeeper(connectString, timeout, new ZNodeAcl());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ZNodeAcl zkServer = new ZNodeAcl(zkServerPath);
